  ...
  return (
    <Component
      className={classNames(
        ...
        // headings
        'prose-headings:scroll-mt-8 prose-headings:font-display prose-headings:font-semibold',
        // lead
        'prose-lead:text-primary dark:prose-lead:text-primary-7',
        // links
        'prose-a:font-semibold dark:prose-a:text-primary-7',
        // link underline
        ...
        // pre
        'prose-pre:rounded-xl prose-pre:bg-black/80 prose-pre:shadow-lg dark:prose-pre:shadow-none dark:prose-pre:ring-1 dark:prose-pre:ring-primary-300/10',
        // hr
        'dark:prose-hr:border-primary'
      )}
      {...otherProps}
    >
      {children}
